...
<abbr onmouseover="alert(1)">test</abbr>.. / .. / .. / .. / .. / .. / etc / passwd
etc/passwd
etc/passwd%00
../../etc/passwd
%252e%252e%252f
...
for test_string in PAYLOADS:
    for rule in ADVANCED_RULES:
        if rule.search(test_string):
